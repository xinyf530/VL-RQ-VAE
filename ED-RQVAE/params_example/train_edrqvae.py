...
def main():
    ...
    EMB_PATH = os.path.join(MODEL_PATH, "fused_bge_emb.pt")
    ...
    NEIGHBOR_LOSS_START_EPOCH = 100   # Strategy B: only introduce after reconstruction converges
    NEIGHBOR_LOSS_RAMP_EPOCHS = 50    # Ramp up slowly over 50 epochs
